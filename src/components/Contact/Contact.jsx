      ...
      <div className="max-w-3xl mx-auto relative">
        ...
        <div>
          ...
          {!messageSended ? (
            <>
              ...
              >
                <div className="flex flex-col gap-1 mb-2">
                  ...
                  />
                  {errors.name && (
                    <small className="text-red-600">Este campo es necesario</small>
                  )}
                </div>
                <div className="flex flex-col gap-1 mb-2">
            ...
            <span>
              Gracias por contactarme. Lo más pronto posible estaré
              comunicándome contigo, espero que puedan salir buenas
